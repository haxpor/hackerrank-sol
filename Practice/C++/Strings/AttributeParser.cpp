/**
 * Solution to Practice/C++/Strings/Attribute Parser
 * Use test case input from AttributeParser.txt file at the same directory.
 *
 * Compile with g++ -std=c++11 AttributeParser.cpp (make sure you are at Practice/C++/Strings/ directory.
 * Execute with ./a.out < AttributeParser.txt
 *
 * Note: you need dummy root node to hold multiple Tag nodes.
 */
